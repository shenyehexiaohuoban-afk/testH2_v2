...
% The formal hourly grid fields are identical across the historical H02
% sensitivity inputs.  The reference package keeps one lightweight input
% source and does not carry historical results directories.
h02SaaFile = baseFile;
h02DroFile = baseFile;

requiredFiles = {baseFile};
