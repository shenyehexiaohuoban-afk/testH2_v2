...
if requestedMode == "saa"
    expectedMode = "SAA";
    expectedEta = 0;
    acceptedSha = "3ef6d441dddcd15056b97da6e03944705a41900397ee7576e0e700c6237c7148";
    defaultFile = fullfile(tableDir, 'terminal_loh_stage89k_saa_adopted.csv');
else
    expectedMode = "DRO";
    expectedEta = 0.03;
    acceptedSha = "2fa1958944110701239a109ebf46d959324a351f2f27c1c3fbd62f333066eaa8";
...
audit = struct('pass',true,'mode',mode,'source_file',sourceFile, ...
    ...
    'adopted_dro_eta',0.03,'state_count',35,'site_count',4, ...
